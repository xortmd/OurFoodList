...
<div class="MapControlView" onclick="getCurrentPos()">여기</div>
	<script>
		// gps로 위치불러오기
			function getCurrentPos(){
				...
				function displayMarker(locPosition, message) { // 마커를 생성합니다
					var imageSrc_loc = "resources/image/maker.png";
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=46275e6cc59632e3f8f889ec73d919d3&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
