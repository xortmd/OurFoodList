...
<head>
	...
	<meta charset="UTF-8">
	<link rel="stylesheet" href="resources/restaurantView.css">
	<title>가게정보</title>
</head>
...
<body>
	...
	<h1><%=restaurant.getRes_name()%></h1>
	<div class="table_container">
		<table class="box">
			<tbody>
				<tr><td><img src=<%=restaurant.getImage_url()%> class="img"></td></tr>
				<tr><td>가게명: <%=restaurant.getRes_name()%></td></tr>
				<tr><td>가게주소: <%=restaurant.getAddress()%></td></tr>
				<tr><td>가게전화번호: <%=restaurant.getRes_phone()%></td></tr>
				<tr><td>음식종류: <%=restaurant.getKind()%></td></tr>
				<tr><td>등록일자: <%=restaurant.getReg_date()%></td></tr>
			</tbody>
		</table>
		<div class="resto_map">
			...
			<ul>
				<li>
					<form action="MyLikeCheckAction" class="heart">
